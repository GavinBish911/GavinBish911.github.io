...
class AppointmentTest {
	 ...
	 * task ID and 50 characters for task desciption. The next test checks to ensure
	 * the date is not before current date. The last 2 tests ensure that each field
	 * is not null. AppointmentID is not tested for being not null because there
	 * isn't a way to create an appointment with a null ID. Likewise, it is not
	 * tested for being non-updateable because there is no way to update it.
	 */
	...
	void testAppointmentDescWithMoreThanFiftyCharacters() {
		Appointment appointment = new Appointment(Date(2022, Calendar.JANUARY, 1),
